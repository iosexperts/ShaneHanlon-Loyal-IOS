...
//        self.view = loadViewFromNib() as! CustomView
    ...
    func SetupUI(imageUrl:String)  {
        ...
        {
            imgView.kf.setImage(with: url,placeholder:#imageLiteral(resourceName: "dummy_banne"))
        }
    }
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "JoinPopUp", bundle: bundle)
